...
/**
 * Copyright (C) 2018 Morteza Hosseini
 * Licensed under the Apache License Version 2.0
 */
public class HomesTechCircularImageView extends AppCompatImageView {
    ...
    public HomesTechCircularImageView(final Context context) {
        this(context, null);
    }

    public HomesTechCircularImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HomesTechCircularImageView(Context context, AttributeSet attrs, int defStyleAttr) {
