...
public class CustomBluetoothLEHelper {
    ...
    public CustomBluetoothLEHelper(Activity _act) {
    ...
    public void write(BluetoothGattCharacteristic mBluetoothGattCharacteristic, byte[] value) {
        mBluetoothGattCharacteristic.setValue(value);
        mBluetoothGatt.writeCharacteristic(mBluetoothGattCharacteristic);
    }

    public void read(BluetoothGattCharacteristic mBluetoothGattCharacteristic) {
        mBluetoothGatt.readCharacteristic(mBluetoothGattCharacteristic);
    }

    public void enableNotify(BluetoothGattCharacteristic mBluetoothGattCharacteristic, boolean notifyStatus) {
        mBluetoothGatt.setCharacteristicNotification(mBluetoothGattCharacteristic, notifyStatus);
    }

    public void write(UUID serviceUUID, UUID characteristicUUUID, byte[] value) {
        BluetoothGattCharacteristic mBluetoothGattCharacteristic = mBluetoothGatt.getService(serviceUUID).getCharacteristic(characteristicUUUID);

        mBluetoothGattCharacteristic.setValue(value);
        mBluetoothGatt.writeCharacteristic(mBluetoothGattCharacteristic);
    }

    public void read(UUID serviceUUID, UUID characteristicUUUID) {
        BluetoothGattCharacteristic mBluetoothGattCharacteristic = mBluetoothGatt.getService(serviceUUID).getCharacteristic(characteristicUUUID);
        mBluetoothGatt.readCharacteristic(mBluetoothGattCharacteristic);
    }

    public void enableNotify(UUID serviceUUID, UUID characteristicUUUID, boolean notifyStatus) {
        mBluetoothGatt.setCharacteristicNotification(mBluetoothGatt.getService(serviceUUID).getCharacteristic(characteristicUUUID), notifyStatus);
    }
